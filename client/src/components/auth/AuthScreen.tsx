            ...
            <form className="space-y-4" onSubmit={submit} noValidate>
              {isRegister && (
                <label className="block">
                  ...
                  {fieldErrors.displayName && <p className="mt-2 text-sm font-medium text-rose-700">{fieldErrors.displayName}</p>}
                </label>
              )}
              <label className="block">
                ...
                {fieldErrors.email && <p className="mt-2 text-sm font-medium text-rose-700">{fieldErrors.email}</p>}
              </label>
              <label className="block">
                ...
                {fieldErrors.password && <p className="mt-2 text-sm font-medium text-rose-700">{fieldErrors.password}</p>}
              </label>
